...
// values are short ("user denied", "code expired"); past this the
// truncated form points at server misbehaviour rather than user-facing
// guidance, and unbounded length is a UX-DoS vector.
